            ...
            <div class="col-lg-9 col-md-12">
                <div class="card sejarah mb-3 pb-3">
                    <div class="card-body">
                        <div class="row g-0">
                            <div class="col-auto">
                                <h1 class="card-title h1-custom">Galeri Desa Tejang</h1>
                            </div>
                            <hr>
                        </div>
                        <div style="display: flex; flex-wrap: wrap; padding: 5px 10px 5px 10px; justify-content: center; gap: 40px;">
                            <?php foreach($galeris as $gal) : ?>
                            <!-- Card-->
                            <div style="width: 250px;" class="card shadow-2xl border-1 rounded">
                                <div class="card-body p-0"><img src="<?= base_url('assets/uploads') ?>/<?= $gal['file_galeri'] ?>" alt="" class="w-100 card-img-top">
                                    <div class="p-4">
                                        <h5 class="mb-0"><?= $gal['judul_galeri'] ?></h5>
                                    </div>
                                </div>
                            </div>
                            <?php endforeach ?> 
